...
<div class="container">
    ...
    <form action="/apoderados/enviar/" name="formApoderado" id="formApoderado" enctype="multipart/form-data" method="POST">
        ...
        <div class="alert alert-danger hide d-print-none" id="error" name="error" role="alert">
        ...
        <div class="form-row">
            <div class="form-group col-md-5">
                <div class="input-group mb-3">
                  ...
                  <label class="form-control" for="voluntario">Participar también como voluntario/a de campaña</label>
                </div>
            </div>
